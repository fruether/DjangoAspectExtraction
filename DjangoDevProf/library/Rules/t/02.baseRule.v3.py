...
from library.Rules.Filters import Filter
...
class FilenameFilter(Filter):
    def apply_filter(self, type, filepath, diff, content):
        return ExperienceAtomCollector(14)
    def __init__(self):
...
class Test(Rule):
    class DirectoryFilter(Filter):
        def apply_filter(self, type, filepath, diff, content):
            return ExperienceAtomCollector(10)
        def __init__(self):
...
class Test2(Rule):
    class DirectoryFilter(Filter):
        def apply_filter(self, type, filepath, diff, content):
            return ExperienceAtomCollector(9)
        def __init__(self):
...
class Test3(Rule):
    class DirectoryFilter(Filter):
        def apply_filter(self, type, filepath, diff, content):
            return ExperienceAtomCollector(None)
        def __init__(self):
...
class Test4(Rule):
    class DirectoryFilter(Filter):
        def apply_filter(self, type, filepath, diff, content):
            return ExperienceAtomCollector(4)
        def __init__(self):
